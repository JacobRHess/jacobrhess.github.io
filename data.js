...
const PROJECTS = [
  // ── APPS ─────────────────────────────────────────────────────
  {
    ...
    desc: "A trailer-leveling app for iPhone and Apple Watch. A clear visual level so you can line up your trailer quickly.",
  ...
  },
  {
    ...
    desc: "Real-time proximity voice chat: talk to people near you. React + Vite frontend wrapped with Capacitor for iOS, Node server, deployed on Fly.io.",
  ...
  },
  {
    ...
    desc: "Detections for intrusions driven by autonomous LLM agents, keyed to the agent's operating rhythm: tool-use loops, inference-latency cadence, retry storms. 10 detections, each proven in CI by replaying attack and benign traces through a real Splunk. The attack telemetry came from a real agent working inside a honeypot sandbox.",
  ...
  },
  {
    ...
    desc: "Detects BadUSB and keystroke-injection attacks by their typing cadence, since no human types at injection speed. Pure-stdlib scorer, CI-replayed labeled trace fixtures, and a live Windows hook.",
  ...
  // ── MISC (published MTG + other released) ────────────────────
  {
    ...
    name: "Wild Map",
    tag: "Web · live",
    desc: "A world map where every pin is a live nature webcam: safari waterholes, bear rivers, coral reefs, eagle nests, erupting volcanoes. Around 200 verified-live streams that play right on the map, a day/night overlay so you can find whatever's awake, and a 'cams near me' finder. It grew out of two single-page walls I built first, one for bat cams and one for bird cams.",
  ...
  },
  {
    ...
    name: "STACK",
    tag: "Daily game · live",
    desc: "A daily Magic: The Gathering card-ranking game. Rank 5 cards three ways: popularity, printings, price. Fully automated from Scryfall data, 21.7k cards across 286 themes.",
  ...
  },
  {
    ...
    desc: "A Discord bot that runs trading-card tournaments end to end: standings, match flow, decklists, auto-generated visual reports and recaps. Deployed on Fly.io.",
